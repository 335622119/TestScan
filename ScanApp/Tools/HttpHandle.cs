...
namespace ScanApp.Tools
{
    class HttpHandle
    {
        ...
        public static HttpResult Get(UrlInfo urlInfo)
        {
            return BaseConn(urlInfo.UrlString, "GET", null, "UTF-8", null, urlInfo.Type);
        }

        public static HttpResult Get(String encode,UrlInfo urlInfo)
        {
            return BaseConn(urlInfo.UrlString, "GET", null, encode, null, urlInfo.Type);
        }

        public static HttpResult Get(String encode, Dictionary<String, String> headers, UrlInfo urlInfo)
        {
            return BaseConn(urlInfo.UrlString, "GET", null, encode, headers, urlInfo.Type);
        }

        public static HttpResult Post(String data, UrlInfo urlInfo)
        {
            return BaseConn(urlInfo.UrlString, "POST", null, "UTF-8", null, urlInfo.Type);
        }

        public static HttpResult Post(String data, String encode, UrlInfo urlInfo)
        {
            return BaseConn(urlInfo.UrlString, "POST", null, encode, null, urlInfo.Type);
        }


        public static HttpResult Post(String data, String encode, Dictionary<String, String> headers, UrlInfo urlInfo)
        {
            return BaseConn(urlInfo.UrlString, "POST", null, encode, headers, urlInfo.Type);
        }


        public static List<String> deathHost = new List<string>();
        public static HttpResult BaseConn(String url, String method, String data, String encode, Dictionary<String, String> headers,bool Type)
        {
            Uri uri = new Uri(url);
            ...
            {
                return httpsSendData(host, port, timeOut, encode, bytes, Type);
            }
            return httpSendData(host, port, timeOut, encode, bytes, Type);
        }
        ...
        public static HttpResult httpSendData(String host, int port, int connectTimeout, String encode, byte[] data,bool Type)
        {
            ...
            try
            {
                ...
                HttpResult result = HttpResultParse.loadSockerStream(socket.GetStream(), encode, host, Type);
                return result;
            }
        ...
        public static HttpResult httpsSendData(String host, int port, int connectTimeout, String encode, byte[] data,bool Type)
        {
            TcpClient socket = null;
            try
            {
                ...
                sslStream.Flush();
                HttpResult result = HttpResultParse.loadSockerStream(sslStream, encode, host, Type);
                return result;
            }
            catch (SocketException)
            {
        ...
        {
            public static HttpResult loadSockerStream(Stream stream, String encode, String host, bool Type)
            {
                ...
                try
                {
                    ...
                    if (!httpResult.IsChunk)
                    {
                        if (Type)
                        {
                            ...
                            if (httpResult.ResultLength > 2000000)
                            {
                                httpResult.Body = "ok";
                                httpResult.Code = 200;
                            }
