...
namespace ScanApp
{
    ...
    {
        //private static string connstr = @"server=localhost;uid=api;pwd=7758521;database=api;charset=utf8";
        private static string connstr = ConfigurationManager.ConnectionStrings["ClassRoomConnectionString"].ToString();//@"Host=127.0.0.1;UserName=root;Password=drpassword;Database=watermonitor;Port=3406;CharSet=utf8;Allow Zero Datetime=true";
        ...
        {
            return DataTableToJson(GetDataTable(sql));
        }
        #endregion
        ...
        /// DataTable 转换成 Json
        /// </summary>
        /// <param name="table">需要转的datatable</param>
        /// <returns></returns>
